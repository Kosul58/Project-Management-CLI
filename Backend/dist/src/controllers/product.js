...
export const addProduct = async (restData) => {
    try {
        ...
        console.error("Error in product Controller addProduct. Failed to add product", err);
        return [];
    }
};
...
export const updateProduct = async (productid, update) => {
    try {
        ...
        console.error("Error in product Controller updateProduct. Failed to update product", err);
        return [];
    }
};
