...
const getProducts = async () => {
    try {
        ...
        console.log("Error in product repository getProducts. Failed to get product data", err);
        throw err;
    }
};
...
const getProductById = async (productid) => {
    try {
        ...
        console.log("Error in product repository getProductByID. Failed to get product data based on productid", err);
        throw err;
    }
};
const addProduct = async (product) => {
    try {
        ...
        console.log("Error in product repository addProduct. Failed to add a product to database", err);
        throw err;
    }
};
const addProducts = async (products) => {
    try {
        ...
        console.log("Error in product repository addProducts. Failed to add products to the database", err);
        throw err;
    }
};
const updateProduct = async (productid, update) => {
    try {
        ...
        console.log("Error in product repository update. Failed to update a product", err);
        throw err;
    }
};
